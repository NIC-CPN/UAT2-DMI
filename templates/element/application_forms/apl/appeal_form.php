		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-dark">
					...
					<div class="card-header"><h3 class="card-title"> Appeal Initiation </h3></div>
						<div class="form-horizontal">
						<div class="card-body">
							<div class="col-sm-12 mb-3"><i class="fa fa-info-circle"></i> Give the Reason for the Appeal
								<div class="row">
									...
									<div class="col-sm-6 d-inline-block">
										<div class="form-group row">
											...
											<div class="custom-file col-sm-9">
												<input type="file" name="supported_document" class="custom-file-input" id="supported_document", multiple='multiple'>
